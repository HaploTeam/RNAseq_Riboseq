...
#####number of buffered genes vs number of translational enhancement genes #####
...
colnames(a)= c('Number of buffered genes',     "Number of enhanced genes"  ,   "strain" ,"vs"   ,  "unique comparison", "number ratio" )

mean(a$ratio)
hist(a$`number ratio`, breaks=10)
